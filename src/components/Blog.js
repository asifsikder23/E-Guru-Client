          ...
          <article className="flex flex-col shadow my-4">
            ...
            <div className="bg-white flex flex-col justify-start p-6">
              ...
              <p className="pb-3">
                ...
                application. It offers NoSQL and real-time hosting of databases,
                content, social authentication, and notifications, or services,
              ...
              <p className="pb-3">
                ...
                Twitter, and more. Options are Auth0, MongoDB, Passport, Okta,
                and Firebase are the most popular alternatives and competitors
          ...
          <article className="flex flex-col shadow my-4">
            ...
            <div className="bg-white flex flex-col justify-start p-6">
              ...
              <p className="pb-3">
                ...
                one request. Node.js basically works on two concept Asynchronous
                Non-blocking I/O
              </p>
            </div>
          </article>
