...
<section className="w-full md:w-2/3 flex flex-col items-center px-3">
    ...
    <article className="flex flex-col shadow my-4">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
            ...
            <a href="#" className="text-3xl font-bold hover:text-gray-700 pb-4">CORS?</a>
            <p href="#" className="text-sm pb-8">
                By <a href="#" className="font-semibold hover:text-gray-800">Md. Asif Ullah Sikder</a>, Published on October 27th, 2020
            </p>
            <h1 className="text-2xl font-bold pb-3">What is CORS?</h1>
            <p className="pb-3">Cross-origin resource sharing (CORS) is a browser mechanism which enables controlled access to resources located outside of a given domain. It extends and adds flexibility to the same-origin policy (SOP). However, it also provides potential for cross-domain attacks, if a website's CORS policy is poorly configured and implemented. CORS is not a protection against cross-origin attacks such as cross-site request forgery (CSRF).</p>
            <p className="pb-3">The role of a CORS policy is to maintain the integrity of a website and secure it from unauthorized access.
    ...
    <article className="flex flex-col shadow my-4">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
            <a href="#" className="text-blue-700 text-sm font-bold uppercase pb-4">Technology</a>
            <a href="#" className="text-3xl font-bold hover:text-gray-700 pb-4">Firebase</a>
            <p href="#" className="text-sm pb-8">
                By <a href="#" className="font-semibold hover:text-gray-800">Md. Asif Ullah Sikder</a>, Published on October 26th, 2020
            </p>
            <h1 className="text-2xl font-bold pb-3">Introduction</h1>
            <p className="pb-3">Firebase is a set of hosting services for any type of application. It offers NoSQL and real-time hosting of databases, content, social authentication, and notifications, or services, such as a real-time communication server.</p>

            <h1 className="text-2xl font-bold pb-3">Why are you using firebase?</h1>
            <p className="pb-3">The Firebase Realtime Database lets you build rich, collaborative applications by allowing secure access to the database directly from client-side code. Data is persisted locally, and even while offline, realtime events continue to fire, giving the end user a responsive experience.</p>
            <h1 className="text-2xl font-bold pb-3">What other options do you have to implement authentication?</h1>
            <p className="pb-3">Firebase Authentication provides backend services, easy-to-use SDKs, and ready-made UI libraries to authenticate users to your app. It supports authentication using passwords, phone numbers, popular federated identity providers like Google, Facebook and Twitter, and more. Options are Auth0, MongoDB, Passport, Okta, and Firebase are the most popular alternatives and competitors to Firebase Authentication.</p>
        </div>
    </article>
    <article className="flex flex-col shadow my-4">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
            <a href="#" className="text-blue-700 text-sm font-bold uppercase pb-4">Technology</a>
            <a href="#" className="text-3xl font-bold hover:text-gray-700 pb-4">Private Route</a>
            <p href="#" className="text-sm pb-8">
                By <a href="#" className="font-semibold hover:text-gray-800">Md. Asif Ullah Sikder</a>, Published on October 24th, 2020
            </p>
            <h1 className="text-2xl font-bold pb-3">How does Private Route Work?</h1>
            <p className="pb-3">The private route component is similar to the public route, the only change is that redirect URL and authenticate condition. If the user is not authenticated he will be redirected to the login page and the user can only access the authenticated routes If he is authenticated (Logged in).</p>
        </div>
    </article>
    <article className="flex flex-col shadow my-4">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
            <a href="#" className="text-blue-700 text-sm font-bold uppercase pb-4">Technology</a>
            <a href="#" className="text-3xl font-bold hover:text-gray-700 pb-4">Node</a>
            <p href="#" className="text-sm pb-8">
                By <a href="#" className="font-semibold hover:text-gray-800">Md. Asif Ullah Sikder</a>, Published on October 20th, 2020
            </p>
            <h1 className="text-2xl font-bold pb-3">What is Node?</h1>
            <p className="pb-3">Node.js is an open-source, cross-platform, back-end JavaScript runtime environment that runs on a JavaScript Engine and executes JavaScript code outside a web browser, which was designed to build scalable network applications.</p>

            <h1 className="text-2xl font-bold pb-3">How does node work?</h1>
            <p className="pb-3"> Node.js accepts the request from the clients and sends the response, while working with the request node.js handles them with a single thread. To operate I/O operations or requests node.js use the concept of threads. Thread is a sequence of instructions that the server needs to perform. It runs parallel on the server to provide the information to multiple clients. Node.js is an event loop single-threaded language. It can handle concurrent requests with a single thread without blocking it for one request.
    ...
    <div className="w-full flex flex-col text-center md:text-left md:flex-row shadow bg-white mt-10 mb-10 p-6">
        <div className="w-full md:w-1/5 flex justify-center md:justify-start pb-4">
            <img src="https://scontent.fdac145-1.fna.fbcdn.net/v/t39.30808-6/274233181_3085646058375783_6690705659848583132_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=174925&_nc_eui2=AeHYmM8By5Myxtb_oY0ILgelRCR17VNXxDBEJHXtU1fEMKDbGp-fVNIrgPRzX4dJhQw7i8rXwM919KgUH0m-9vlS&_nc_ohc=QolRrm1g3DYAX_pWeqX&_nc_ht=scontent.fdac145-1.fna&oh=00_AfArrUEdIx_n8paQcHC_cJliCDAT48-HQrTyg-IYeS41_Q&oe=635F1FED" className="rounded-full shadow h-32 w-32"/>
        </div>
        <div className="flex-1 flex flex-col justify-center md:justify-start">
            <p className="font-semibold text-2xl">Md. Asif Ullah Sikder</p>
            <p className="pt-2">Honest and have a very good manner. I spend my time to work on development because it's my passion I like fruit, ice-cream and my most favorite biryiaani and like to play Chess.</p>
            <div className="flex items-center justify-center md:justify-start text-2xl no-underline text-blue-800 pt-4">
                ...
                <a className="pl-4" href="https://www.instagram.com/asifullahsikder/">
                    <i className="fab fa-instagram"></i>
                </a>
                <a className="pl-4" href="https://twitter.com/asifsikder23">
                    <i className="fab fa-twitter"></i>
                </a>
                <a className="pl-4" href="https://www.linkedin.com/in/md-asif-ullah-sikder-a6993b178/">
...
<div className="w-full md:w-1/3 flex flex-col items-center px-3">
    ...
    <div className="w-full bg-white shadow flex flex-col my-4 p-6">
        ...
        <p className="pb-2">The way we work has been irreversibly disrupted. Covid-19 has unmasked a desire for people to work on their own terms. At their own pace. In their own environment. As hybrid workplaces increasingly become the norm, hybrid learning is reinventing the way we approach professional and on-the-job training & education. Let our guide be your guide to adopting hybrid learning into your training programs.</p>
